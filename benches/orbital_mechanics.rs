...
use helios_ascension::fleets::orbital_mechanics::{
    compute_gravity_assist, compute_transfer_window, find_gravity_assist_options,
    hohmann_transfer, phase_dv_factor, AU_IN_METERS, GM_SUN,
};
...
fn bench_hohmann_transfer(c: &mut Criterion) {
    ...
    c.bench_function("hohmann_transfer_many_bodies", |b| {
        b.iter(|| {
            ...
            let bodies = [(0.39, 0.72), (0.72, 1.0), (1.0, 1.52), (1.52, 5.2),
                          (5.2, 9.58), (9.58, 19.2), (19.2, 30.0)];
            for (r1, r2) in bodies {
