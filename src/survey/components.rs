...
use super::types::{
    ...
    AnomalyType, MissionStatus, SurveyDimension, SurveyMethod, INITIAL_CONFIDENCE, MAX_TIER,
    WARNING_CONFIDENCE,
};
...
/// the lifecycle, progress, and scientist-team fields. PR-C will
/// add the [`AnalysisJob`] enqueue on completion.
