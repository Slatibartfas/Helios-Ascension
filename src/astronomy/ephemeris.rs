...
mod tests {
    ...
    fn test_days_from_j2000_calculation() {
        ...
        assert!(
            (days_from_j2000 - 9496.0).abs() < 1.0,
            "Days from J2000 should be ~9496"
        );
    }
    ...
    fn test_earth_position_jan_2026() {
        ...
        assert!(
            (earth_ma - 356.86).abs() < 1.0,
            "Earth MA should be ~356.86°, got {}",
            earth_ma
        );
    }
    ...
    fn test_jupiter_position_jan_2026() {
        ...
        assert!(
            (jupiter_ma - 88.68).abs() < 1.0,
            "Jupiter MA should be ~88.68°, got {}",
            jupiter_ma
        );
    }
    ...
    fn test_moon_position_jan_2026() {
        ...
        assert!(
            (moon_ma - 337.70).abs() < 10.0,
            "Moon MA should be ~337.70°, got {}",
            moon_ma
        );
    }
