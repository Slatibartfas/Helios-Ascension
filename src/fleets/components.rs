...
pub struct ActiveManeuver {
    ...
    /// intentionally NOT reflect-serialised — same pattern
    /// `PlannedTransfer` uses to keep the action queue serialisable.
    /// After a save/load round-trip this field is the
