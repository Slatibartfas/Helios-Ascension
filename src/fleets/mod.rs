            ...
            .add_systems(
                ...
                (
                    ...
                    visuals::draw_fleet_trajectories
                        .after(systems::update_fleet_maneuver_positions),
                    visuals::draw_fleet_icons
                        .after(systems::update_fleet_orbit_positions),
                    visuals::draw_fleet_starmap_icons,
                    visuals::draw_fleet_selection_reticule
                        .after(visuals::update_fleet_transforms),
                    visuals::draw_fleet_orbit_rings
                        .after(visuals::update_fleet_transforms),
                    visuals::draw_fleet_transfer_preview
                        .after(visuals::update_fleet_transforms),
                    visuals::draw_gravity_assist_preview
                        .after(visuals::update_fleet_transforms),
                    visuals::ensure_fleet_meshes,
                    visuals::update_fleet_mesh_materials
                        .after(visuals::ensure_fleet_meshes),
