...
mod tests {
    ...
    fn test_is_module_available_for_module_tier() {
        // GRA-354 executable documentation of the tier-cap rule.
        // Tier-5 module cannot be unlocked by a tier-3 tech.
        assert!(!TechnologiesData::is_module_available_for_module_tier(3, 5));
        // Tier-6 module needs tier-6+ tech.
        ...
        // Tier-N module unlocked by exactly tier-N tech.
        assert!(TechnologiesData::is_module_available_for_module_tier(1, 1));
        // No tech (tier 0) cannot unlock any module.
        assert!(!TechnologiesData::is_module_available_for_module_tier(0, 1));
        // Tier-N tech can always unlock tier-(N-1) and below.
